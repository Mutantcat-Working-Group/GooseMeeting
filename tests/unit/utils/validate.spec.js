...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/Mutantcat-Working-Group/GooseMeeting')).toBe(true)
    expect(validURL('http://github.com/Mutantcat-Working-Group/GooseMeeting')).toBe(true)
    expect(validURL('github.com/Mutantcat-Working-Group/GooseMeeting')).toBe(false)
  })
  it('validLowerCase', () => {
